Meteor.startup(function () {
  ...
  if(Books.find().count() === 0) {
    ...
    Books.insert({
      ...
      imageUrl: 'http://ecx.images-amazon.com/images/I/51BHym2c8DL.jpg',
      format: 'Book',
    ...
    Books.insert({
      ...
      imageUrl: 'http://ecx.images-amazon.com/images/I/51yrWrw4MeL.jpg',
      format: 'E-Book',
    ...
    Books.insert({
      ...
      imageUrl: 'http://ecx.images-amazon.com/images/I/61OA4d8MKdL.jpg',
      format: 'Book',
